...
Sprite_Animation.prototype.updateScene = function() {
    this.updateMain();
    this.updateFlash();
...
//wolfzq追加加速判定，非战斗可以加速
Sprite_Animation.prototype.isSkipForward = function() {
...
Sprite_Balloon.prototype.updateScene = function() {
    if (this._duration > 0) {
        this._duration--;
        if (this._duration > 0) {
            this.updateFrame();
