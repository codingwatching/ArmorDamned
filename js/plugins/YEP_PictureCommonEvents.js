...
Game_Interpreter.prototype.pictureMove = function() {
	$gamePlayer.touchMove = true;
};
...
Scene_Map.prototype.updatePictureEventCheck = function(check) {
    ...
    if (!picture) return;
	$gameMap._buttonId = picture.pictureId();
    $gameTemp.reserveCommonEvent(check[$gameMap._buttonId]);
    $gameTemp.clearDestination();
};
