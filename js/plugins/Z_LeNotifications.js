...
var pNotifGainGold = String(parameters['Notif Gain Gold'] || '+[value] G');
var pNotifLoseGold = String(parameters['Notif Lose Gold'] || '-[value] G');
var pNotifGainItem = 'false';//'获得 [name] x[amount]';
var pNotifLoseItem = 'false';//String(parameters['Notif Lose Item'] || '失去 [name] x[amount]');
var pNotifGainExp = 'false';//String(parameters['Notif Gain Exp'] || '[name]: +[value] Exp');
var pNotifLoseExp = 'false';//String(parameters['Notif Lose Exp'] || '[name]: -[value] Exp');
var pNotifLevelUp = 'false';//String(parameters['Notif LevelUp'] || '[name]: 等级提升 !');
var pNotifLevelDown = 'false';//String(parameters['Notif LevelDown'] || '[name]: 等级降低 !');
var pNotifBgm = 'false';//String(parameters['Notif BGM'] || "Playing '[name]'");
