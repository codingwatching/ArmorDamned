 ...
 *
 * @param Command Width
 * @desc 这是命令窗口的宽度，以像素为单位。
 * Default: 240
 * @default 240
 *
 * @param Hide Actor Window
 * @desc 你想隐藏main actor窗口吗？
 * NO - false     YES - true
 * @default false
 *
 ...
 *
 * @param Menu 1 Name
 * @desc 这是对菜单命令的名称。这是一个评估。
 * 比如状态:TextManager.status
 * @default
 *
 * @param Menu 1 Symbol
 * @desc 这是对菜单命令的标志。这需要对每一单独的菜单命令。
 * 这需要对每一单独的菜单命令。
 * @default
 *
 * @param Menu 1 Show
 ...
 *
 * @param Menu 1 Ext
 * @desc 这是一个扩展的菜单命令。这是一个评估。
 * @default
 *
 * @param Menu 1 Main Bind
 * @desc 这是由该命令的菜单的功能活性。这是一个评估。
 * @default
 *
 * @param Menu 1 Actor Bind
 * @desc 如果该命令的菜单选择一个字符驱动的激活功能，
 * 这是在选择一个字符。
 * @default
 *
 * @param ---Menu 2---
 ...
 * @desc Esse é o nome para o comando do menu. Isso é um eval. Para fazê-lo em
 * string, use 'aspas' em volta do nome.
 * @default TextManager.playerInfo
 *
 ...
 * @param Menu 26 Show
 * @desc Essa é a condição eval para esse comando de menu aparecer.
 * @default this.needsCommand('playerInfo')
 *
 ...
 * @desc Essa é a função ativada por esse comando de menu.
 * Isso é um eval.
 * @default this.commandPlayerInfo.bind(this)
 *
 ...
 * @desc Esse é o nome para o comando do menu. Isso é um eval. Para fazê-lo em
 * string, use 'aspas' em volta do nome.
 * @default TextManager.playerTitle
 *
 ...
 * @param Menu 27 Show
 * @desc Essa é a condição eval para esse comando de menu aparecer.
 * @default this.needsCommand('playerTitle')
 *
 ...
 * @desc Essa é a função ativada por esse comando de menu.
 * Isso é um eval.
 * @default this.commandPlayerTitle.bind(this)
 *
 ...
 * Actor Bind:
 *
 * 这项命令是用上面的例子。这就像Textmanager.item
 * 命令的名称将显示。他叫的名字输入信息
 * 文本管理器的数据库中，并使用“Item”的任何东西
 * 在你的数据库中。“Item”符号是用来做什么的
 * indentificador 命令的唯一项目。为显示命令，他会
 * 执行功能 'needsCommand' 检查他是否会来。这
 * 功能 'needsCommand' 与你的数据库在你的项目或不来. 
 * 这是启用的命令的命令，他会检查是否启用或不主要,
 * 这是密切相关的特点，是否有在当前的党.最后，
 * 源代码行this.commanditem.bind’（这是）”命令将执行后，输入项被选中
